...
const Features = () => {
    return (
        <div className="md:min-h-screen min-h-[1000px] flex flex-col bg-slate-50 items-center justify-center space-y-8 overflow-hidden">
{/* Top half */}
            <div className="w-full h-1/2 md:w-3/4 flex flex-col md:flex-row items-center">
                <div className="w-full md:w-1/2 h-3/4 flex flex-col items-center">
                    <div className="w-full md:w-13/4 h-full border-gray-400 p-8 ">
                        <p className="font-bold text-gray-400 h-1/4 mb-2">Save in Bitcoin</p>
                        <h3 className='font-bold lg:text-4xl text-3xl h-1/2'>A fun and easy way for anyone to learn about bitcoin while they accumulate and save with Bitgy Bank.</h3>
                        <br/>
...
{/* Bottom Half */}
            <div className="w-full h-1/2 md:w-3/4 flex flex-col md:flex-row items-center">
                ...
                <div className="md:block md:w-1/2 h-3/4 flex flex-col items-center border-blue-400">
                    <div className="w-full md:w-13/4 h-full border-gray-400 p-8">
                        <p className="font-bold text-gray-400 h-1/4 mb-2">Self Custody</p>
                        <h3 className='font-bold lg:text-4xl text-3xl h-1/2'>You hold the keys to your Bitgy Bank - No third parties can access your funds</h3>
                        <br/>
