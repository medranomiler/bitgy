    ...
    <div className='min-h-96 flex flex-col md:flex-row justify-center items-center px-8 py-8 md:px-0 md:py-8 bg-slate-50'>
        ...
        <br/>
            <form className="md:w-1/3 md:mx-8 md:flex md:justify-center md:items-center" onSubmit={handleSubmit}>
              ...
              <button type="submit" className="relative -left-2 font-bold text-black p-2 sm:p-4 rounded-r-full border border-2 sm:border-t-4 sm:border-l-4 sm:border-b-4 sm:border-r-4 border-black bg-slate-50 hover:text-white hover:bg-black">Lets Go!</button>
            </form>
    </div>
  )
}
