    ...
    return (
        <div className="md:h-screen min-h-[1000px] flex flex-col bg-slate-50 items-center overflow-hidden">
            ...
            {/* <div className="w-full h-3/4 flex flex-col items-center">
                ...
                <div className="flex justify-center items-center w-full h-full">
                    <img src={Bitcoin} className="md:h-64 md:w-auto w-[300px] h-auto translate-x-4 -translate-y-4" /><img src={Key} className="md:h-24 md:w-auto w-64 h-auto animation-key" />
                    </div>
                </div>
